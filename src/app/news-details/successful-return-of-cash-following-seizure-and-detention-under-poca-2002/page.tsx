      ...
      >
        ...
        >
          <span data-aos="zoom-in" data-aos-duration="500">
            ...
            under section 295(8) of the Proceeds of Crime Act 2002 (“the Act”).
            Following the initial seizure of the cash the police successfully
            applied to the Magistrates’ Court for the cash to be further
            detained pursuant to section 295(2) of the Act on the basis “that
            there are reasonable grounds for suspecting that the cash is
          ...
          <span data-aos="zoom-in" data-aos-duration="500">
            ...
            witness statements along with supporting documentation, diligently
            and painstakingly compiled by our team, we were able to demonstrate
            the legitimate provenance of the cash. Therefore, the Police have
            agreed to return the entire sum of money to our clients without the
            matter proceeding to a full contested hearing. This has saved the
            Applicant’s a great deal of expense and time.
          </span>
          <br />
          <br />
          <span data-aos="zoom-in" data-aos-duration="500">
